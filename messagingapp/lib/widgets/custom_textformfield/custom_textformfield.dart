...
class CustomTextFormField extends StatefulWidget {
  ...
  const CustomTextFormField({
    ...
    this.focusedShadowColor = CustomColors.color00DE90,
    ...
    this.focusedTextColor = CustomColors.color00DE90,
    this.unFocusedTextColor = CustomColors.color22242A,
    this.focusedSuffixColor = CustomColors.color00DE90,
    this.focusedPrefixColor = CustomColors.color00DE90,
